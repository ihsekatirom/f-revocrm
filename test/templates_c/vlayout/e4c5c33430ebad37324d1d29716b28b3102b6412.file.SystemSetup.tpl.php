<?php /* Smarty version Smarty-3.1.7, created on 2018-05-12 12:46:33
         compiled from "/var/www/html/frevocrm/includes/runtime/../../layouts/vlayout/modules/Users/SystemSetup.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18882685975af6e229e887c6-13769868%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e4c5c33430ebad37324d1d29716b28b3102b6412' => 
    array (
      0 => '/var/www/html/frevocrm/includes/runtime/../../layouts/vlayout/modules/Users/SystemSetup.tpl',
      1 => 1496690968,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18882685975af6e229e887c6-13769868',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5af6e229ef63e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5af6e229ef63e')) {function content_5af6e229ef63e($_smarty_tpl) {?>﻿
<html lang="en"><head><title>F-RevoCRM セットアップ</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link REL="SHORTCUT ICON" HREF="layouts/vlayout/skins/images/favicon.ico"><link rel="stylesheet" href="libraries/bootstrap/css/bootstrap.css" type="text/css" media="screen" /><link rel="stylesheet" href="libraries/bootstrap/css/bootstrap-responsive.css" type="text/css" media="screen"><style type="text/css">
                    body{
                ...
                </script><div class="container-fluid page-container"><!-- <div class="row-fluid"><div class="span6"><div class="logo"><img src="test/logo/vtiger-crm-logo.png" alt="Vtiger Logo"/></div></div><div class="span6"></div></div> --><div class="row-fluid main-container"><div class="span12 inner-container"><div class="row-fluid"><div class="span8"><h3 style="display: inline-block;float:left;">オプションモジュール選択</h3><p style="display: inline-block;float:left;margin-top:4px;">&nbsp;&nbsp;インストールしたいモジュールオプションを選択してください</p></div><div class="span4"><div class="pull-right"><label for="checkbox-1" style="vertical-align:bottom;margin:0;margin-top:8px\9;margin-left:10px\9;font-size:15px;"><strong>すべて選択</strong></label> <input type="checkbox" name="selectAll" class="selectAll"/><div class="chkbox"></div></div></div></div><hr><form id="SystemSetup" class="form" method="POST" action="index.php?module=Users&action=SystemSetupSave"><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['PACKAGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PACKAGE_INFO']->_loop = false;
