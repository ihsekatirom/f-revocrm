<?php /* Smarty version Smarty-3.1.7, created on 2018-05-12 12:47:21
         compiled from "/var/www/html/frevocrm/includes/runtime/../../layouts/vlayout/modules/Vtiger/MenuBar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10029032675af6e25973de58-14214753%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '80ca203c86fce3066ebd229a898d9b587359ca15' => 
    array (
      0 => '/var/www/html/frevocrm/includes/runtime/../../layouts/vlayout/modules/Vtiger/MenuBar.tpl',
      1 => 1496690968,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10029032675af6e25973de58-14214753',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5af6e2599411f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5af6e2599411f')) {function content_5af6e2599411f($_smarty_tpl) {?>
...
" /></a><?php }else{ ?><?php $_smarty_tpl->tpl_vars['first_name'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('first_name'), null, 0);?><?php $_smarty_tpl->tpl_vars['last_name'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('last_name'), null, 0);?><?php if (strlen($_smarty_tpl->tpl_vars['first_name']->value)>0&&strlen($_smarty_tpl->tpl_vars['last_name']->value)>0){?><?php $_smarty_tpl->tpl_vars['title'] = new Smarty_variable(($_smarty_tpl->tpl_vars['last_name']->value).($_smarty_tpl->tpl_vars['first_name']->value), null, 0);?><?php }else{ ?><?php $_smarty_tpl->tpl_vars['title'] = new Smarty_variable($_smarty_tpl->tpl_vars['first_name']->value, null, 0);?><?php }?><?php if (empty($_smarty_tpl->tpl_vars['title']->value)){?><?php $_smarty_tpl->tpl_vars['title'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('last_name'), null, 0);?><?php }?><span class="dropdown-toggle" data-toggle="dropdown" href="#"><a id="menubar_item_right_<?php echo stripslashes($_smarty_tpl->tpl_vars['title']->value);?>
"  class="userName textOverflowEllipsis" title="<?php echo stripslashes($_smarty_tpl->tpl_vars['title']->value);?>
"><strong><?php echo stripslashes($_smarty_tpl->tpl_vars['title']->value);?>
