<?php /* Smarty version Smarty-3.1.7, created on 2018-05-12 19:42:19
         compiled from "/var/www/html/frevocrm/includes/runtime/../../layouts/vlayout/modules/Vtiger/RelatedList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2790028445af7439bae19f7-16235932%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3ce1328ee35669b2487661727d8d7ec9e7f90c1c' => 
    array (
      0 => '/var/www/html/frevocrm/includes/runtime/../../layouts/vlayout/modules/Vtiger/RelatedList.tpl',
      1 => 1496690968,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2790028445af7439bae19f7-16235932',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5af7439bc5f42',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5af7439bc5f42')) {function content_5af7439bc5f42($_smarty_tpl) {?>
...
" nowrap><?php if ($_smarty_tpl->tpl_vars['HEADER_FIELD']->value->isNameField()==true||$_smarty_tpl->tpl_vars['HEADER_FIELD']->value->get('uitype')=='4'){?><?php if ($_smarty_tpl->tpl_vars['HEADER_FIELD']->value->getModuleName()=="Calendar"&&$_smarty_tpl->tpl_vars['HEADER_FIELD']->value->getName()=="subject"){?><a id="full_activity_<?php echo $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getId();?>
" data-tooltip="#html_full_activity_<?php echo $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getId();?>
...
</a><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path('ActivityBalloon.tpl'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('activityid'=>$_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getId(),'activitytype'=>$_smarty_tpl->tpl_vars['RELATED_RECORD']->value->get("activitytype"),'gravity'=>"west"), 0);?>
<?php }else{ ?><a href="<?php echo $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getDetailViewUrl();?>
"><?php echo $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getDisplayValue($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value);?>
</a><?php }?><?php }elseif($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value=='access_count'){?><?php echo $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getAccessCountValue($_smarty_tpl->tpl_vars['PARENT_RECORD']->value->getId());?>
