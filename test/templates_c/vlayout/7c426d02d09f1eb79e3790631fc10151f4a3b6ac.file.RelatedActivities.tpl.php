<?php /* Smarty version Smarty-3.1.7, created on 2018-05-12 19:03:28
         compiled from "/var/www/html/frevocrm/includes/runtime/../../layouts/vlayout/modules/Vtiger/RelatedActivities.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7054430565af73a8038b202-53196225%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7c426d02d09f1eb79e3790631fc10151f4a3b6ac' => 
    array (
      0 => '/var/www/html/frevocrm/includes/runtime/../../layouts/vlayout/modules/Vtiger/RelatedActivities.tpl',
      1 => 1496690968,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7054430565af73a8038b202-53196225',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5af73a8048612',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5af73a8048612')) {function content_5af73a8048612($_smarty_tpl) {?>
...
&nbsp;-&nbsp;<?php if ($_smarty_tpl->tpl_vars['DETAILVIEW_PERMITTED']->value=='yes'){?><a id="full_activity_<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
" data-tooltip="#html_full_activity_<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
" href="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getDetailViewUrl();?>
" ><?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('subject');?>
</a><?php }else{ ?><span id="full_activity_<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
" data-tooltip="#html_full_activity_<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
"><?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('subject');?>
</span><?php }?>&nbsp;<?php if ($_smarty_tpl->tpl_vars['EDITVIEW_PERMITTED']->value=='yes'){?><a href="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getEditViewUrl();?>
...
"></i></a><?php }?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path('ActivityBalloon.tpl'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('activityid'=>$_smarty_tpl->tpl_vars['RECORD']->value->getId(),'activitytype'=>$_smarty_tpl->tpl_vars['RECORD']->value->get("activitytype"),'gravity'=>"east"), 0);?>
</div></div><hr><?php } ?><?php }else{ ?><div class="summaryWidgetContainer"><p class="textAlignCenter"><?php echo vtranslate('LBL_NO_PENDING_ACTIVITIES',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
